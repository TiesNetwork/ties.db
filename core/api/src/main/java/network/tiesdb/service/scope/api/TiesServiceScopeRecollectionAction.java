...
public interface TiesServiceScopeRecollectionAction extends TiesServiceScopeAction, TiesServiceScopeAction.Distributed {
    ...
    public interface Result extends TiesServiceScopeResultAction.Result {
