...
public enum TiesDBType implements TiesEBMLType {
    ...
    BILLING_REQUEST(0x11504159, Context.BILLING_REQUEST, Context.ROOT), // Meta
    BILLING_CHEQUE_COUNT_LIMIT(0x80, Context.VALUE, Context.BILLING_REQUEST), // Unsigned
    BILLING_CHEQUE_AMOUNT_THRESHOLD(0x82, Context.VALUE, Context.BILLING_REQUEST), // Unsigned
    BILLING_RESPONSE(0x12504159, Context.BILLING_RESPONSE, Context.ROOT), // Meta
    ...
    public static enum Context implements EBMLType.Context {
        ...
        BILLING_RESPONSE(RESPONSE, CHEQUE_LIST_CONTAINER), //
