 ...
 */
public enum TiesCoordinatorServiceVersionImpl implements TiesVersion {
    ...
    private TiesCoordinatorServiceVersionImpl(TiesApiVersion apiVersion, Integer majorVersion, Integer minorVersion, Integer incrementalVersion) {
